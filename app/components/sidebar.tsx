    ...
    <div className={`  ${fold ? "w-[75px] " : "w-[215px] "}  transi text-sm `}>
      ...
      <div className="pt-6">
        <div
          className={` ${
            fold ? "hidden" : "flex"
          } text-gray-600  pl-6 font-semibold`}>
          PAGES YOU LIKE
        </div>
        <section>
          <div
            className={` ${
              fold ? "justify-center" : "pt-5 justify-start pl-6"
            } flex cursor-pointer`}>
            ...
            <div
              className={` ${
                fold ? "hidden " : "flex"
              } font-semibold text-gray-600 pl-3 translate-y-1`}>
              Fashion Design
            </div>
          </div>{" "}
          <div
            className={`flex pt-4 ${
              fold ? "justify-center" : "justify-start pl-6"
            }   cursor-pointer`}>
            <div className=" h-8 w-8 text-gray-600 flex justify-center">
              <svg
                xmlns="http://www.w3.org/2000/svg"
